...
SLOT="0"
IUSE="accessibility +aio alsa bluetooth +caps +curl debug fdt glusterfs gtk
iscsi +jpeg kernel_linux kernel_FreeBSD mixemu ncurses opengl +png pulseaudio
python rbd sasl +seccomp sdl selinux smartcard spice static static-softmmu \
